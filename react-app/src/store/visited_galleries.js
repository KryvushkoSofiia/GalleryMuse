const READ_VISITED_GALLERY = 'galleryVisited/READ_VISITED_GALLERY';
const ADD_TO_VISITED = 'galleryVisited/ADD_TO_VISITED';
const REMOVE_FROM_VISITED = 'galleryVisited/REMOVE_FROM_VISITED';
const UPDATE_GALLERY_STATUS = 'galleryVisited/UPDATE_VISITED_STATUS';
...
export const getVisitedGalleryThunk = () => async (dispatch) => {
  try {
    ...
    if (response.ok) {
      ...
      console.log('visited_galleries from thunk', visitedGalleries);
